                ...
                <table class="table table-striped b-t b-light">
                    ...
                    @foreach($all_product as $key => $product)
                        <tr>
                            ...
                            <td>{{$product->product_desc}}
                            </td>
                            <td>{{$product->product_content}}
                            </td>
                            <td>{{$product->product_price}}
                            </td>
                            <td> <img src="public/uploads/product/{{$product->product_image}}" height="100" width="100">
                            </td>
                            ...
                            <td><span class="text-ellipsis">1.11.2023</span></td>
                            <td>
                                <a href="{{URL::to('edit-product/'.$product->product_id)}}"
                                   class="active ui-toggle-class"><i
                                        class="fa fa-pencil-square-o text-success text-active"></i>
                                </a>
                                <a onclick="return confirm('Bạn có muốn xoá danh mục này không?')"
